	...
	it("fails when passed a file with a syntax error", async () => {
		...
		await assert.rejects(promise, ({ code, stdout, stderr }) => {
			...
			const expectedStderr =
				"\x1B[0m\n" +
				"\x1B[4mbad-examples.md\x1B[24m\n" +
				"   \x1B[2m11:4\x1B[22m  \x1B[31merror\x1B[39m  Missing language tag: use one of 'javascript', 'js', 'jsx', 'ts', or 'tsx'\n" +
				"   \x1B[2m12:1\x1B[22m  \x1B[31merror\x1B[39m  Unexpected lint error found: Parsing error: 'import' and 'export' may appear only with 'sourceType: module'\n" +
				...
				"   \x1B[2m79:1\x1B[22m  \x1B[31merror\x1B[39m  Unexpected lint error found: /* eslint-env */ comments are no longer supported\n" +
				"   \x1B[2m84:1\x1B[22m  \x1B[31merror\x1B[39m  Configuration error: Key \"languageOptions\": Unexpected key \"foo\" found\n" +
				"   \x1B[2m97:7\x1B[22m  \x1B[31merror\x1B[39m  Unexpected lint error found: Using 'ArrayPattern' is not allowed \x1B[2mno-restricted-syntax\x1B[22m\n" +
