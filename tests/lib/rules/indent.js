...
ruleTester.run("indent", rule, {
	...
	invalid: [
		...
		},
		{
            ...
            `,
			options: ["tab"],
			errors: expectedErrors([2, "1 tab", "4 spaces"]),
		},
		{
			code: unIndent`
                function App() {
		...
		},
		{
            ...
            `,
			options: ["tab"],
			errors: expectedErrors([3, "1 tab", "1 space"]),
		},
		{
			/*
			 * Multiline ternary
